...
def build_invoice_pdf(*, invoice: Any, rental: Any, customer: Any, car: Any, pickup_location: Any, return_location: Any, rental_status: Any, invoice_status: Any, payment_status: Any, payment_method: Any, discount: Any) -> bytes:
    ...
    lines = [
        ...
        (f"Start date: {_format_value(rental.start_date)}", REGULAR_FONT_NAME, 11),
        (f"Planned end date: {_format_value(rental.planned_end_date)}", REGULAR_FONT_NAME, 11),
        (f"Actual end date: {_format_value(rental.actual_end_date)}", REGULAR_FONT_NAME, 11),
