...
__all__ = ["admin_cars_router", "admin_customers_router", "admin_discounts_router", "admin_rentals_router", "customer_cars_router", "customer_users_router", "login_router", "signup_router"]
